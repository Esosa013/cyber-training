...
export interface User {
  ...
  export const MOCK_USERS: User[] = [
    {
      id: 'user1',
      name: 'Fortress Charles',
      email: 'fortress@gmail.com',
      password: '123456',
      avatar: '/assets/avatars/avatar1.png',
      level: 3,
      points: 750,
      badges: ['phishing-expert', 'quick-learner'],
      completedScenarios: ['scenario1', 'scenario2', 'scenario4'],
      teamId: 'team1'
    },
    {
      id: 'user2',
      ...
      points: 420,
      badges: ['password-pro'],
      completedScenarios: ['scenario1', 'scenario3'],
      teamId: 'team1'
    },
    {
      id: 'user3',
      ...
      level: 4,
      points: 980,
      badges: ['phishing-expert', 'security-champion', 'data-guardian'],
      completedScenarios: ['scenario1', 'scenario2', 'scenario3', 'scenario5'],
      teamId: 'team2'
    },
    {
      id: 'user14',
    ...
    },
    {
      ...
      level: 3,
      points: 670,
      badges: ['network-defender', 'mobile-guardian'],
      completedScenarios: ['scenario1', 'scenario3', 'scenario4'],
      teamId: 'team2'
    },
    {
      id: 'user5',
      ...
      level: 5,
      points: 1100,
      badges: ['security-champion', 'social-savvy', 'password-pro', 'data-guardian'],
      completedScenarios: ['scenario1', 'scenario2', 'scenario3', 'scenario4', 'scenario6'],
      teamId: 'team3'
    },
    {
      id: 'user6',
      ...
      level: 2,
      points: 380,
      badges: ['workspace-protector', 'quick-learner'],
      completedScenarios: ['scenario1', 'scenario5'],
      teamId: 'team3'
    },
    {
      id: 'user7',
      name: 'Quinn O\'Sullivan',
      email: 'q.osullivan@company.com',
      avatar: 'https://i.pravatar.cc/150?img=7',
      password: '123456',
      level: 4,
      points: 850,
      badges: ['phishing-master', 'classification-expert', 'network-defender'],
      completedScenarios: ['scenario1', 'scenario3', 'scenario4', 'scenario7'],
      teamId: 'team3'
    },
    {
      id: 'user8',
      ...
      level: 3,
      points: 580,
      badges: ['remote-warrior', 'password-pro'],
      completedScenarios: ['scenario2', 'scenario5', 'scenario8'],
      teamId: 'team4'
    },
    {
      id: 'user9',
      ...
      level: 5,
      points: 1200,
      badges: ['security-champion', 'secure-coder', 'incident-responder', 'phishing-expert'],
      completedScenarios: ['scenario1', 'scenario2', 'scenario3', 'scenario4', 'scenario6', 'scenario9'],
      teamId: 'team4'
    },
    {
      id: 'user10',
      name: 'Zoe Martinez',
      email: 'z.martinez@company.com',
      avatar: 'https://i.pravatar.cc/150?img=10',
      password: '123456',
      level: 3,
      points: 620,
      badges: ['phishing-novice', 'mobile-guardian', 'social-savvy'],
      completedScenarios: ['scenario1', 'scenario3', 'scenario7'],
      teamId: 'team4'
    },
    {
      id: 'user11',
      ...
      level: 2,
      points: 350,
      badges: ['password-pro', 'quick-learner'],
    ...
    },
    {
      ...
      level: 4,
      points: 890,
      badges: ['data-guardian', 'remote-warrior', 'classification-expert'],
      completedScenarios: ['scenario3', 'scenario4', 'scenario5', 'scenario8'],
      teamId: 'team5'
    },
    {
      id: 'user13',
      name: 'Noah Kim',
      email: 'n.kim@company.com',
      avatar: 'https://i.pravatar.cc/150?img=13',
      password: '123456',
      level: 3,
      points: 720,
      badges: ['supply-chain-guardian', 'network-defender'],
      completedScenarios: ['scenario1', 'scenario6', 'scenario9'],
      teamId: 'team5'
    }
  ];
